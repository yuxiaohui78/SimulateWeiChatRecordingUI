...
public class MainActivity extends Activity implements OnClickListener {
	...
	private String[] msgArray = new String[] { "Who are you?","I am Mike","Where are you from?","China ","Glad to meet you.","Glad to meet you too."};
		...
		if (btn_vocie) {
			...
			if (event.getAction() == MotionEvent.ACTION_DOWN && flag == 1) {
				...
				if (event.getY() >= del_Y
					...
					//change 1000 to 500 to enlarge the record time
